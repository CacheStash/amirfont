...
import TypeTester from './components/TypeTester'; // Import tanpa {}
...
// -- MAGNETIC TEXT COMPONENT (FluidText) --
// Logika ini sudah diperbaiki untuk menangani 'opsz' agar font tidak pecah
  ...
  const handleMouseMove = (e: React.MouseEvent<HTMLDivElement>) => {
    ...
    charsRef.current.forEach((span) => {
      ...
      if (distance < maxDistance) {
        ...
        // PENTING: Force 'opsz' 14 agar Chrome tidak meresetnya saat wght berubah
...
const App: React.FC = () => {
  return (
    <div className="min-h-screen bg-gray-50 text-black p-4 md:p-8 font-sans selection:bg-black selection:text-white relative">
      ...
      {/* Site Header */}
      <header className="max-w-7xl mx-auto mb-16 border-b-[4px] border-black pb-8">
      ...
      <main className="max-w-7xl mx-auto space-y-32">
        ...
        {/* Footer */}
        <footer className="grid grid-cols-1 md:grid-cols-4 gap-8 border-t-[4px] border-black pt-12 text-xs font-mono uppercase tracking-wider text-gray-500 mb-20">
            <div>
