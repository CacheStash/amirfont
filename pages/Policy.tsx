...
const Policy: React.FC = () => {
  ...
  return (
    <div className="relative z-10 text-black font-sans selection:bg-black selection:text-white min-h-screen bg-transparent overflow-x-hidden uppercase">
      ...
      <div className="grain-orb-base orb-top-right !top-auto !bottom-[-15%] !left-[2%] !opacity-100 !scale-[1.8]" />
      <div className="grain-orb-base orb-top-right !top-auto !bottom-[-15%] !left-[2%] !opacity-50 !scale-[2.8] blur-2xl" />
