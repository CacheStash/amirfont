...
const License: React.FC = () => {
  ...
  const TermCard: React.FC<{ number: string, title: string, children: React.ReactNode }> = ({ number, title, children }) => (
    <div className="mb-12 w-full border border-black bg-white relative z-10">
      {/* Title Section: Nomor di sisi kiri title dengan font yang identik */}
  ...
  return (
    <div className="relative z-10 text-black font-sans selection:bg-black selection:text-white min-h-screen bg-transparent overflow-x-hidden uppercase">
      ...
      {/* VIBRANT BACKGROUND ORBS - Sesuai posisi request */}
      {/* 1. Atas Kanan */}
      <div className="grain-orb-base orb-top-right" />
      
      {/* 2. Kiri Tengah (Custom positioning based on orb-bottom-left style) */}
      <div className="grain-orb-base orb-bottom-left !top-[40%] !-left-[15%] !opacity-40" />
      
      {/* 3. Bawah Kanan (Custom positioning based on orb-top-right style) */}
      <div className="grain-orb-base orb-top-right !top-auto !bottom-0 !-right-[10%] !bg-red-600/20" />

      <div className="w-full relative z-10">
        {/* HEADER SECTION - Konsisten dengan FAQ/Fonts/Policy */}
        <header className="px-6 py-16 md:px-8 border-b border-black mb-12 bg-transparent text-left">
          ...
          <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
            <p className="text-[10px] md:text-xs font-normal text-gray-600 uppercase tracking-widest">
              Clear Additive Terms for Creative Freedom
            </p>
            {/* Info Terakhir Update */}
            <p className="text-[10px] md:text-xs font-normal text-black uppercase tracking-widest">
          ...
          <TermCard number="06" title="Legal Breach">
            <BrutalBox className="bg-[#fffafa] border-red-200">
              <p className="text-base md:text-3xl font-normal normal-case leading-relaxed text-black">
                ...
                Subqi Studio reserves the right to terminate the license immediately if terms are not met, including using tiers that do not match the organization scale.
              </p>
            </BrutalBox>
          </TermCard>
