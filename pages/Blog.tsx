  ...
  return (
    <div className="max-w-7xl mx-auto p-4 md:p-8 min-h-screen">
       <div className="mb-12 border-b-[3px] border-black pb-8">
        <h2 className="text-6xl font-black uppercase tracking-tighter mb-4">Blog</h2>
      ...
      <div className="flex flex-col gap-0 border-t-[3px] border-black">
        {posts.map((post, idx) => (
          <div key={idx} className="group flex flex-col md:flex-row justify-between items-start md:items-center py-8 border-b border-black hover:bg-gray-50 cursor-pointer transition-colors px-2">
            <div>
              <span className="inline-block px-2 py-1 bg-black text-white text-[10px] font-mono uppercase mb-2">{post.category}</span>
              <h3 className="text-2xl md:text-4xl font-bold uppercase tracking-tight group-hover:underline decoration-2 underline-offset-4">{post.title}</h3>
            </div>
